...
<html>
	...
	<script src="jquery.wiggle.min.js"></script>
        ...
        $(document).ready(function(){
           $(".btype").t('"Die Zeit verwandelt uns nicht. Sie entfaltet uns nur."', {speed:75, speed_vary:false, delay:true, caret: false, blink: false, fin:function(){ 
                   $(".stype").t('- Max Frisch', {speed:90, speed_vary:false, delay:true, caret: false, blink: false, 
                       fin:function() {
    ...
    <body>
        ...
        <div class="mainseq">
            <div class="seqborder">
                ...
                <div class="seqtext" id="m9"><p>...</p></div>
            </div>
        </div>
